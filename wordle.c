...
#define ENG_3_DICT_FILE DICTIONARY_DIR "3_letter_words_ENG.txt"
#define ENG_4_DICT_FILE DICTIONARY_DIR "4_letter_words_ENG.txt"
#define ENG_5_DICT_FILE DICTIONARY_DIR "5_letter_words_ENG.txt"
#define ENG_6_DICT_FILE DICTIONARY_DIR "6_letter_words_ENG.txt"
#define ENG_7_DICT_FILE DICTIONARY_DIR "7_letter_words_ENG.txt"
#define ENG_8_DICT_FILE DICTIONARY_DIR "8_letter_words_ENG.txt"


#define ENG_DICT_FILE ENG_5_DICT_FILE


#define FRA_DICT_FILE DICTIONARY_DIR "5_letter_words_FRA.txt"
#define ITA_DICT_FILE DICTIONARY_DIR "5_letter_words_ITA.txt"
#define ROM_DICT_FILE DICTIONARY_DIR "5_letter_words_ROM.txt"
#define ESP_DICT_FILE DICTIONARY_DIR "5_letter_words_ESP.txt"
#define DEU_DICT_FILE DICTIONARY_DIR "5_letter_words_DEU.txt"
...
int main(int argc, char **argv)
{
    ...
    while(1)
    {
        ...
        instructions();
        printf("\nChoose language\n1 = English, 2 = French, 3 = Italian, 4 = Romanian, 5 = Spanish, 6 = German :");
